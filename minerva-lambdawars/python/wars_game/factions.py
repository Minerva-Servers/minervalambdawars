...
class FactionRebelsMinervaWarsInfo(FactionRebelsDestroyHQInfo):
    name = 'minervawars_rebels'
    startbuilding = 'minervawars_build_reb_hq'
    startunit = 'minervawars_unit_reb_scout_unarmed'
    resources = ['requisition', 'scrap']
    
'''
class FactionBanditsMinervaWarsInfo(FactionRebelsDestroyHQInfo):
    name = 'minervawars_bandits'
    displayname = 'Bandits'
    startbuilding = 'minervawars_build_band_hq'
    startunit = ''
    resources = ['requisition', 'scrap']
'''

class FactionCombineMinervaWarsInfo(FactionCombineDestroyHQInfo):
    name = 'minervawars_combine'
    startbuilding = 'minervawars_build_comb_hq'
    startunit = 'minervawars_unit_comb_loyalist'
    resources = ['requisition', 'power']
    
'''
class FactionRoguesMinervaWarsInfo(FactionCombineDestroyHQInfo):
    name = 'minervawars_rogues'
    displayname = 'Rogues'
    startbuilding = 'minervawars_build_rog_hq'
    startunit = ''

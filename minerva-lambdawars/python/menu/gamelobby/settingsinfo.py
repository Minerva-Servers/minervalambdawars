...
class SettingsInfo(object):
    ...
    allcolors = {
        ...
        '12darkblue': {'name': '12darkblue', 'color': Color(0, 20, 200, 255)},
        ...
        '2red': {'name': '2red', 'color': Color(200, 0, 0, 255)},
        ...
        '9orange': {'name': '9orange', 'color': Color(200, 96, 0, 255)},
        '9orange2': {'name': '9orange2', 'color': Color(255, 128, 32, 255)},
    }
    
    #: CPU difficulties
    availabledifficulties = [
        {'id': 'easy', 'displayname': 'Easy'},
        {'id': 'medium', 'displayname': 'Normal'},
        {'id': 'difficult', 'displayname': 'Difficult'},
        {'id': 'hard', 'displayname': 'Hard'},
        {'id': 'veryhard', 'displayname': 'Very Hard'},
        {'id': 'legend', 'displayname': 'Legend'},
        {'id': 'godlike', 'displayname': 'God-Like'},
        {'id': 'impossible', 'displayname': 'Impossible'},
    ]
